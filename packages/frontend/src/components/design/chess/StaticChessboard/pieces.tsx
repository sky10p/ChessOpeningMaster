...
const S: React.CSSProperties = { overflow: "visible" };

export const PIECES: Record<string, React.ReactNode> = {
  wP: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={S}>
      <path
        d="m 22.5,9 c -2.21,0 -4,1.79 -4,4 0,0.89 0.29,1.71 0.78,2.38 C 17.33,16.5 16,18.59 16,21 c 0,2.03 0.94,3.84 2.41,5.03 C 15.41,27.09 11,31.58 11,39.5 H 34 C 34,31.58 29.59,27.09 26.59,26.03 28.06,24.84 29,23.03 29,21 29,18.59 27.67,16.5 25.72,15.38 26.21,14.71 26.5,13.89 26.5,13 c 0,-2.21 -1.79,-4 -4,-4 z"
        style={{ fill: "#ffffff", stroke: "#000000", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "miter" }}
      />
    </svg>
  ),
  bP: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={S}>
      <path
        d="m 22.5,9 c -2.21,0 -4,1.79 -4,4 0,0.89 0.29,1.71 0.78,2.38 C 17.33,16.5 16,18.59 16,21 c 0,2.03 0.94,3.84 2.41,5.03 C 15.41,27.09 11,31.58 11,39.5 H 34 C 34,31.58 29.59,27.09 26.59,26.03 28.06,24.84 29,23.03 29,21 29,18.59 27.67,16.5 25.72,15.38 26.21,14.71 26.5,13.89 26.5,13 c 0,-2.21 -1.79,-4 -4,-4 z"
        style={{ fill: "#000000", stroke: "#000000", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "miter" }}
      />
    </svg>
  ),
  wR: (
  ...
  bR: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={S}>
      <g style={{ fill: "#000000", stroke: "#000000", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round" }}>
        ...
        <path d="M 12,35.5 L 33,35.5" style={{ fill: "none", stroke: "#ffffff", strokeWidth: 1, strokeLinejoin: "miter" }} />
  ...
  wK: (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45" width="100%" height="100%" style={S}>
      <g style={{ fill: "none", stroke: "#000000", strokeWidth: 1.5, strokeLinecap: "round", strokeLinejoin: "round" }}>
        <path d="M 22.5,11.63 L 22.5,6" style={{ strokeLinejoin: "miter" }} />
        <path d="M 20,8 L 25,8" style={{ strokeLinejoin: "miter" }} />
        <path d="M 22.5,25 C 22.5,25 27,17.5 25.5,14.5 C 25.5,14.5 24.5,12 22.5,12 C 20.5,12 19.5,14.5 19.5,14.5 C 18,17.5 22.5,25 22.5,25" style={{ fill: "#ffffff", strokeLinecap: "butt", strokeLinejoin: "miter" }} />
