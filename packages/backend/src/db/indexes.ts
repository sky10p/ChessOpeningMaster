...
export async function ensureDatabaseIndexes(db: Db): Promise<void> {
  ...
  await Promise.all([
    ...
    createIndexSafely(db, "importedGames", { userId: 1, source: 1, playedAt: -1 }),
    createIndexSafely(db, "importedGames", { userId: 1, orientation: 1, playedAt: -1 }),
    createIndexSafely(db, "importedGames", { userId: 1, rated: 1, playedAt: -1 }),
    createIndexSafely(db, "importedGames", { userId: 1, tournamentGroup: 1, playedAt: -1 }),
    createIndexSafely(db, "importedGames", { userId: 1, timeControlBucket: 1, playedAt: -1 }),
    createIndexSafely(db, "importedGames", { userId: 1, "openingMapping.repertoireId": 1, playedAt: -1 }),
    createIndexSafely(db, "importedGames", { userId: 1, "openingMapping.requiresManualReview": 1, playedAt: -1 }),
    createIndexSafely(db, "importedGames", { userId: 1, source: 1, orientation: 1, timeControlBucket: 1, playedAt: -1 }),
